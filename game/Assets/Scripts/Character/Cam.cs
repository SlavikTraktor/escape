...
public class Cam : MonoBehaviour {
	...
	void LateUpdate(){
		if (player.transform.position.x < endWall.transform.position.x - 2f && player.transform.position.x > startWall.transform.position.x + 3f)
			transform.position = new Vector3 (player.transform.position.x + offset.x, transform.position.y, transform.position.z);
		
		if (player.transform.position.x >= endWall.transform.position.x - 2f) {
			//transform.position = new Vector3 (transform.position.x - 0.001f, transform.position.y, transform.position.z);
			offset.x = transform.position.x - player.transform.position.x ;
		}

		if (transform.position.x <= startWall.transform.position.x +3f) {
			//transform.position = new Vector3 (transform.position.x + 0.001f, transform.position.y, transform.position.z);
			offset.x = transform.position.x - player.transform.position.x ;
		}
	}
